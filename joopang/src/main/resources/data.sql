...
VALUES
    (400, DATE_SUB(CURDATE(), INTERVAL 1 DAY), 24),
    (400, DATE_SUB(CURDATE(), INTERVAL 2 DAY), 17),
    (400, DATE_SUB(CURDATE(), INTERVAL 3 DAY), 11),
    (401, DATE_SUB(CURDATE(), INTERVAL 1 DAY), 56),
    (401, DATE_SUB(CURDATE(), INTERVAL 2 DAY), 42),
    (401, DATE_SUB(CURDATE(), INTERVAL 3 DAY), 31),
    (402, DATE_SUB(CURDATE(), INTERVAL 1 DAY), 28),
    (402, DATE_SUB(CURDATE(), INTERVAL 2 DAY), 33),
    (402, DATE_SUB(CURDATE(), INTERVAL 3 DAY), 19)
...
VALUES
    (904, 901, 'DIRECT_DELIVERY', '06000', 'Seoul, Gangnam-gu, Teheran-ro 152', '12F', '010-1234-5678', DATE_ADD(CURDATE(), INTERVAL 3 DAY), 'IN_TRANSIT', 'JP123456789KR', 3000)
