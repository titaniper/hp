package io.joopang.presentation.order

import io.joopang.application.order.OrderUseCase
...
class OrderController(
    ...
    private fun CreateOrderRequest.toCommand(): OrderUseCase.CreateOrderCommand =
    ...
    private fun CreateOrderItemRequest.toCommand(): OrderUseCase.CreateOrderItemCommand =
        OrderUseCase.CreateOrderItemCommand(
            productId = productId,
    ...
    private fun OrderUseCase.PaymentResult.toResponse(): PaymentResponse =
        PaymentResponse(
            orderId = orderId,
            status = status.name,
