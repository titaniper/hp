...
import io.joopang.application.order.OrderService.CreateOrderCommand
import io.joopang.application.order.OrderService.CreateOrderItemCommand
...
class OrderServiceConcurrentTest : DescribeSpec({
    ...
    describe("processPayment") {
        it("completes payment without changing reserved stock") {
            ...
            result.status.shouldBe(OrderService.PaymentStatus.SUCCESS)
